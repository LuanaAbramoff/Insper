  ...
  port   (
   ...
   PC_OUT: out std_logic_vector(larguraEnderecos-1 downto 0);
    LEDR  : out std_logic_vector(9 downto 0);
	 ...
	 Reg_A: out std_logic_vector(larguraDados-1 downto 0)
  );
end entity;


architecture arquitetura of Aula5_JEQ is
  ...
  signal Logica_Desvio : std_logic;
...
logicaDesvio1 : entity work.logicaDesvio
          port map (jmp => JUMP , jeq => JEQ, habIgual =>Flag_Igual_Saida, saida => Logica_Desvio);
