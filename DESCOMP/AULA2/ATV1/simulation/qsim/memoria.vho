...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100000001000100000000000000000001000000010001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~4_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & (!\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ $ (\Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100000000000100000000000000000001000000000001000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~2_combout\ = ( \memROM~0_combout\ & ( (\Endereco[0]~input_o\ & (!\Endereco[1]~input_o\ & (!\Endereco[2]~input_o\ & !\Endereco[3]~input_o\))) ) )
